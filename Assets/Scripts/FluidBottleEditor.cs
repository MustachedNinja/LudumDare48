...
class FluidBottleEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        this.m_fluidBottle.FluidParticles = (ParticleSystem) EditorGUILayout.ObjectField("Fluid Particle System", this.m_fluidBottle.FluidParticles, typeof(ParticleSystem), true);
